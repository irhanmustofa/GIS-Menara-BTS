...
<div class="row">
	<div class="card mt-4">
		<h4 class="card-title mt-3 ms-3">Ubah Data Pengguna</h4>
		<p class="card-category ms-3">Masukkan Data Pengguna Yang Ingin Diganti</p>
...
if (isset($_POST["simpan"])) {
	...
	echo "<script>location = 'user_tampil.php'</script>";
}
include "footer.php";
?>