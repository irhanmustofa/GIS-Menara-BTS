...
if (isset($_GET["id"])){
	//menampilkan data menara sesuai kategori
	$id_kategori = $_GET["id"];
	$menara = array();
	$ambil_menara = $koneksi -> query("SELECT * FROM menara LEFT JOIN desa ON menara.nama_kecamatan = desa.nama_kecamatan LEFT JOIN kecamatan ON kecamatan.nama_kecamatan = desa.nama_kecamatan WHERE id_kategori = '$id_kategori'");
	...
	<div class="card mt-4" >
		...
		<div class="card-body">
			<div class="d-grid gap-2 d-md-flex justify-content-md-end pb-3">
				<a href="menara_tambah.php" type="button" class="btn btn-success " type="button">
