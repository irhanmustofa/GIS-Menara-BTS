...
$jumlah_user = mysqli_num_rows($ambil_petugas);
							...
							<div class="col-md-3">
								<div class="card text-bg-success mb-3">
									...
									<div class="card-body">
										...
										<h1 class="card-text"><?php echo $jumlah_menara; ?></h1>
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="card text-bg-warning mb-3">
									...
									<div class="card-body">
										...
										<h1 class="card-text"><?php echo $jumlah_kecamatan; ?></h1>
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="card text-bg-primary mb-3">
									...
									<div class="card-body">
										...
										<h1 class="card-text"><?php echo $jumlah_pemilik; ?></h1>
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="card text-bg-danger mb-3">
									<div class="card-header">Jumlah Pemgguna</div>
									<div class="card-body">
										<h5 class="card-title">Total Jumlah User</h5>
										<h1 class="card-text"><?php echo $jumlah_user; ?></h1>
									</div>
								</div>
							</div>
							<div class="col-md-12">
