...
if (isset($_GET["id"])){
	...
	$id_kategori = $_GET["id"];
	$menara = array();
	$ambil_menara = $koneksi -> query("SELECT * FROM menara LEFT JOIN desa ON menara.id_desa = desa.id_desa LEFT JOIN kecamatan ON kecamatan.id_kecamatan = desa.id_kecamatan WHERE id_kategori = '$id_kategori'");
